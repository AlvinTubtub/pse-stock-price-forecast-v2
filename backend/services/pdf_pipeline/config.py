...
# Repo-root pipeline-run metadata, read by the frontend (via the exported
# latest.json) to show when data was last refreshed — written once per run, regardless of
